...
def main():
    ...
    parser.add_argument('--contrast_type', default='InstanceCL', type=str, 
                        help="Ways to contrastive of. \
                        Support InstanceCL and ShortInterestCL, IntentCL, and Hybrid types.")
    parser.add_argument('--num_intent_clusters', default='64', type=str, 
    ...
    parser.add_argument('--seq_representation_instancecl_type', default='concatenate', type=str, 
                        help="operate of item representation overtime. Support types: \
                        mean, concatenate")
    parser.add_argument("--warm_up_epoches", type=float, default=300, \
                        help="number of epochs to start IntentCL.")
    parser.add_argument("--de_noise", action="store_true", \
                        help="whether to de-false negative pairs during learning.")
    ...
    cluster_dataset = RecWithContrastiveLearningDataset(args, 
    ...
    trainer = ICLRecTrainer(model, train_dataloader, cluster_dataloader, \
